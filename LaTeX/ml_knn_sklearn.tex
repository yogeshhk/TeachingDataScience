...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Review of the Iris Dataset: Loading}
\begin{lstlisting}
import pandas as pd
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Review of the Iris Dataset: Features}
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Plot Iris Dataset: Code}
Exploratory Data Analysis
\begin{lstlisting}
from matplotlib.colors import ListedColormap

# one color per species, used below
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Plot Iris Dataset: What We See}
Exploratory Data Analysis
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Measuring Error: A Single k}
With $k=1$
\begin{lstlisting}
...
from sklearn import metrics
score_1 = metrics.accuracy_score(actual, predicted)
print(score_1) #0.94
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Measuring Error: Trying a Range of k}
...
K=1,5, 15,50
\begin{center}
\includegraphics[width=0.36\linewidth,keepaspectratio]{knn11}
\includegraphics[width=0.36\linewidth,keepaspectratio]{knn12}\\
\includegraphics[width=0.36\linewidth,keepaspectratio]{knn13}
\includegraphics[width=0.36\linewidth,keepaspectratio]{knn14}
\end{center}
\small{Question: What's the ``best'' K here? Answer: the one giving accurate predictions
on unseen data, found via the range-of-k sweep on the previous slide, not by eyeballing
the boundary.}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: KNN with Scikit-Learn}
\begin{block}{Think About It}
If you evaluate a $k=1$ KNN model by measuring its accuracy on the very same data it was
fit on, it will score close to 100\%. Why is this measurement almost meaningless, and how
does the ``Measuring Error'' code above (using \texttt{train\_test\_split}) fix it?
\end{block}
\end{frame}
...
\begin{frame}[fragile]\frametitle{Quick Check: KNN with Scikit-Learn}
\begin{block}{Answer}
With $k=1$, every training point's single nearest neighbor is itself, so it trivially
predicts its own label: the score reflects memorization, not generalization to unseen
data. Splitting into train/test sets forces the model to predict labels for points it never
saw during fitting, which is the only way to estimate how it will perform on new data.
\end{block}
\end{frame}
