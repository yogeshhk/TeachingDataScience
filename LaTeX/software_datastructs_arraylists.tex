...
words or other arrays.
	...
	\input{images/tikz/array.tex}
			...
			\begin{itemize}
			\item 	\lstinputlisting{../Code/python/array.py}
			\item
			\item 	\lstinputlisting{../Code/python/array2.py}
			\item
			\item 	\lstinputlisting{../Code/python/array3.py}
	\end{itemize}
...
\begin{frame}
	...
	\lstinputlisting{../Code/python/ll_search.py}
...
\begin{frame}
	...
	\end{itemize}
	\lstinputlisting{../Code/python/ll_get.py}
\end{frame}
...
\begin{frame}
	\frametitle{Inserting at the head or tail}
		...
		\item \lstinputlisting{../Code/python/ll_prepend.py}
		
				
		\item \lstinputlisting{../Code/python/ll_append.py}
	\end{itemize}	
...
\begin{frame}
	...
	\lstinputlisting{../Code/python/ll_insert.py}
...
\lstinputlisting{../Code/python/ll_remove_first.py}
		
			\item 
		
\lstinputlisting{../Code/python/ll_remove_last.py}
