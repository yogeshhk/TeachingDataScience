...
% \includegraphics[width=0.8\linewidth,keepaspectratio]{foundation_models}
% \end{center}
\end{frame}
...
% \includegraphics[width=0.8\linewidth,keepaspectratio]{ai_hierarchy_updated}
% \end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.85\linewidth,keepaspectratio]{gartner34}
\end{center}
