...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% STAGE 12: PRODUCTION .claude/ SETUP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{}
\begin{center}
{\Large Stage 12: Production \texttt{.claude/} Setup}
\end{center}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{The Problem: Every Session Is Day One}
  \begin{itemize}
...
\textbf{Step 1 --- Create the Python style rule:}
\begin{lstlisting}
...
\textbf{Step 2 --- Verify it activates automatically:}
\begin{lstlisting}
...
\textbf{Step 3 --- Add a security rule for all files:}
\begin{lstlisting}
...
\textbf{Create the codebase explorer on Haiku (cheap + fast):}
\begin{lstlisting}
...
\textbf{Create the security-focused code reviewer on Sonnet:}
\begin{lstlisting}
...
\textbf{Invoke:} Ask ``How does the chatbot handle conversation state?'' --- Haiku fires. Ask ``Review src/mychatbot/chain.py for security issues'' --- Sonnet fires.
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Demo: Auto-Triggered Security Skill}

\textbf{Create a skill that fires automatically on API/config changes:}
\begin{lstlisting}
