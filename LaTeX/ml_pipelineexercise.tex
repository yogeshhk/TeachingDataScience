...
\end{lstlisting}
\vspace{15pt}
6 features, 96\% test accuracy, beating both the 10-feature filter model and coming
close to the full 27-feature model -- on cross validation too, not just this one split.
\end{frame}
