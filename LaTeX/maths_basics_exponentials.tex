...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Exponentials \& Logarithms}
\begin{block}{Think About It}
If $\log_2(x) = 10$, roughly how big is $x$ -- tens, hundreds, or over a thousand? What does this tell you about how logarithms compress large numbers?
\end{block}
\pause
\begin{block}{Answer}
