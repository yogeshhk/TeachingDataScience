...
$\mathbb{N} \subseteq \mathbb{Z} \subseteq \mathbb{Q} \subseteq \mathbb{R} \subseteq \mathbb{C} $, with $\mathbb{P} = \mathbb{R} \setminus \mathbb{Q}$ (irrationals are the reals that are \emph{not} rational -- disjoint from $\mathbb{Q}$, not a superset of it)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Numbers}
