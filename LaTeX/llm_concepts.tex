...
\begin{frame}[fragile]\frametitle{}
\begin{center}
{\Large Language Modeling Fundamentals}
\end{center}
\end{frame}
...
\begin{frame}[fragile]\frametitle{}
\begin{center}
{\Large From Probabilities to Models}
\end{center}
\end{frame}
...
\begin{frame}[fragile]\frametitle{Transformers}
	...
	\begin{center}
	\includegraphics[width=0.7\linewidth,keepaspectratio]{llm112}
	\end{center}
...
\begin{frame}[fragile]\frametitle{Autoencoders}
	...
	\begin{center}
	\includegraphics[width=0.8\linewidth,keepaspectratio]{llm113}
	\end{center}
...
\begin{frame}[fragile]\frametitle{Reward Modeling (RM)}
		...
		\begin{center}
		\includegraphics[width=0.5\linewidth,keepaspectratio]{rag19}
		\end{center}
...
\begin{frame}[fragile]\frametitle{Reward Modeling (RM)}
		...
		\begin{center}
		\includegraphics[width=0.5\linewidth,keepaspectratio]{rag20}
		\end{center}
...
\begin{columns}
    \begin{column}[T]{0.6\linewidth}
        \begin{itemize}
            \item Combines LLMs with external knowledge bases
            \item Vector databases (Pinecone, Weaviate, Chroma)
            \item Embedding models for retrieval
            \item Reduces hallucinations
            \item Enables up-to-date information
        \end{itemize}
    \end{column}
    \begin{column}[T]{0.4\linewidth}
        % \includegraphics[width=\linewidth]{rag_diagram}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Production Deployment}
\begin{itemize}
    \item Inference Optimization:
        \begin{itemize}
            \item Quantization (INT8, INT4)
            \item FlashAttention-2
            \item Speculative decoding
        \end{itemize}
    \item Serving Frameworks:
        \begin{itemize}
            \item vLLM, TGI (Text Generation Inference)
            \item Ray Serve, TensorRT-LLM
        \end{itemize}
    \item Cost Management:
        \begin{itemize}
            \item Batch processing
            \item Caching strategies
            \item Model selection per task
        \end{itemize}
\end{itemize}
\end{frame}