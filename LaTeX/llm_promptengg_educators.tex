...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NEW SLIDE: Personalised Student Feedback, high-value educator use-case not previously covered
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Writing Personalised Student Feedback}

    \begin{itemize}
        \item \textbf{Situation:} You have 30 assignments to mark and need to write meaningful, individual feedback for each student, not a copy-paste comment.
