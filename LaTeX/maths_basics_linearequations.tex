...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Linear Equations}
...
\pause
\begin{block}{Answer}
The system is inconsistent -- it has no solution. A row that reads $0x_1 + 0x_2 + \dots = 6$ is a false statement, which means no values of the variables can satisfy every equation simultaneously.
\end{block}
\end{frame}
