...
\begin{center}
\includegraphics[width=0.4\linewidth,keepaspectratio]{cnn70}

\includegraphics[width=0.4\linewidth,keepaspectratio]{cnn71}

\tiny{(Ref: Deep Learning for Natural Language 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile] \frametitle{Transformation So Far}

\begin{center}
\includegraphics[width=0.8\linewidth,keepaspectratio]{cnn69}
