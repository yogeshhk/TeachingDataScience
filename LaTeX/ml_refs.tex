...
Weekend Projects:
\begin{enumerate}
\item Build a spam classifier (2-3 hours)
\item Train an image classifier (Kaggle Dogs vs Cats)
\item Create a chatbot with LangChain
\item Participate in a Kaggle competition
\end{enumerate}
