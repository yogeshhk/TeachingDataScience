...
\begin{block}{Intuition}
Elimination is just a shortcut for the graphical picture: two lines cross at exactly one point (usually). Instead of drawing both lines and reading off the crossing point, we algebraically cancel a variable so only one unknown remains.
\end{block}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Equations}
