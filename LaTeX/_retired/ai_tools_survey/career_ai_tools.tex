...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{The Modern AI Stack (2024+)}
\begin{columns}
    \begin{column}[T]{0.5\linewidth}
    \textbf{Models (The Brains)}
    \begin{itemize}
        \item Proprietary: GPT-4o, Claude 3.5 Sonnet, Gemini 1.5 Pro
        \item Open Weights: Llama 3.1, Mistral, Qwen
    \end{itemize}
    \textbf{Orchestration (The Glue)}
    \begin{itemize}
        \item LangChain
        \item LlamaIndex
    \end{itemize}
    \end{column}
    \begin{column}[T]{0.5\linewidth}
    \textbf{Memory (The Context)}
    \begin{itemize}
        \item Vector DBs: Pinecone, Chroma, Weaviate
    \end{itemize}
    \textbf{Hubs (The Repository)}
    \begin{itemize}
        \item \textbf{Hugging Face}: The "GitHub of AI". Essential for datasets and open-source models.
    \end{itemize}
    \end{column}
\end{columns}
\end{frame}
...
\textit{How to stop AI from hallucinating and know your private data.}
\begin{enumerate}
\item \textbf{Retrieval:} User asks a question $\rightarrow$ System searches your company PDFs/SQL.
\item \textbf{Augmentation:} System pastes relevant info into the Prompt.
\item \textbf{Generation:} LLM answers the question using \textit{only} that info.
\end{enumerate}

% \begin{center}
% % Suggestion: Simple RAG architecture diagram
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Coding Assistants}
Writing code from scratch is obsolete.
\begin{itemize}
\item \textbf{Cursor / Windsurf:} AI-native code editors.
\item \textbf{GitHub Copilot:} Autocomplete for logic.
\item \textbf{Claude 3.5 Sonnet (Artifacts):} Generate full UIs and visualizations in seconds.
\end{itemize}
\end{frame}
