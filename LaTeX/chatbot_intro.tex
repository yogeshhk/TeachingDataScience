...
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio]{chatbot61}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\linewidth,keepaspectratio]{chatbot28}
\end{center}
...
\tiny{(Ref: Understanding AI Chatbots, Challenges, Opportunities \& Beyond - Pramod Chandrayan)}
    ...
    \begin{column}[t]{0.5\linewidth}
\begin{center}
\includegraphics[width=0.65\linewidth,keepaspectratio]{chatbot19a}
...
\begin{frame}[fragile]\frametitle{History}
    ...
    \begin{column}[t]{0.5\linewidth}
\begin{center}
\includegraphics[width=0.8\linewidth,keepaspectratio]{chatbot19b}

\end{center}
    \end{column}
    \begin{column}[t]{0.5\linewidth}
\begin{center}
\includegraphics[width=0.8\linewidth,keepaspectratio]{chatbot19c}
