...
\begin{frame}[fragile]\frametitle{Text splitter}
 ...
 \begin{columns}
    \begin{column}[T]{0.5\linewidth}
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag74}
    ...
    \begin{column}[T]{0.5\linewidth}
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag75}
...
\begin{frame}[fragile]\frametitle{Character splitter}
  	...
  	\begin{center}
	\includegraphics[width=0.5\linewidth,keepaspectratio]{rag76}
	
	\includegraphics[width=0.5\linewidth,keepaspectratio]{rag77}
...
\begin{frame}[fragile]\frametitle{Recursive Character Splitter}
 ...
 \begin{columns}
    \begin{column}[T]{0.5\linewidth}
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag78}
    ...
    \begin{column}[T]{0.5\linewidth}
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag79}
...
\begin{frame}[fragile]\frametitle{Sentence Splitter Approach}
  	...
  	\begin{center}
	\includegraphics[width=0.5\linewidth,keepaspectratio]{rag80}
	
	\includegraphics[width=0.5\linewidth,keepaspectratio]{rag81}
...
\begin{frame}[fragile]\frametitle{Semantic Splitting - The Favorite Method}
 ...
 \begin{columns}
    \begin{column}[T]{0.5\linewidth}
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag82}
    ...
    \begin{column}[T]{0.5\linewidth}
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag83}
...
\item Produces self-sufficient sentences with resolved references
  \end{itemize}
  	...
  	\begin{center}
	\includegraphics[width=0.75\linewidth,keepaspectratio]{rag84}
...
\begin{frame}[fragile]\frametitle{LLM-Based Chunking: Propositions}
	...
	\includegraphics[width=0.8\linewidth,keepaspectratio]{rag85}
...
\begin{frame}[fragile]\frametitle{Document-Specific Splitting with Unstructured}
	...
	\includegraphics[width=0.6\linewidth,keepaspectratio]{rag86}
...
\item Enables faster debugging and system improvement
  \end{itemize}
	...
	\includegraphics[width=0.6\linewidth,keepaspectratio]{rag87}
