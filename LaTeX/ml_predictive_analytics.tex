...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{The Story: Netflix's \$1 Million Prize}
Heard of ``Netflix''?
\begin{itemize}
...
\item Better recommendations mean more engagement and more revenue.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{The Story: Merging into Ensembles}
Solution!!!
\begin{itemize}
...
\item But Netflix never ran the winning ensemble in production: the accuracy gain did not justify the engineering effort to deploy it
\item Lesson: a model is only valuable if it can be deployed and run reliably
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{The Story: Micro-Targeting Voters}
Heard of political micro-targeting?
\begin{itemize}
...
\item Political campaigns worldwide, including in India, now rely heavily on predictive analytics for voter targeting.
\item Caution: the 2018 Cambridge Analytica scandal showed how personal data can be misused for such targeting
\end{itemize}
...
\begin{center}
\includegraphics[width=0.9\linewidth]{predanat3}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{What is Predictive Analytics?: Definition}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{What is Predictive Analytics?: How It Works}
...
\item Traditional analytics or statistical methods fail on complex, non-linear, multi-variable combinations.
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{Business Applications: Overview}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{Business Applications: Supply Chain \& HR}
\begin{itemize}
\item Supply Chain:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{Business Applications: Energy, Finance \& E-Commerce}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{Business Applications: Quality, Fraud \& Healthcare}
\begin{itemize}
...
\begin{itemize}
\item To improve everyday business operations
...
\begin{itemize}
\item Based on past data, the system may identify that `Rahul' will most likely not renew his membership.
\item How?
...
\begin{itemize}
\item Say your business has a Rs 50,000 marketing budget but three lakh customers.
\item You obviously can't extend a 10 percent discount to every single one of them.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{How Does Predictive Analytics Work?: Define the Question}
\adjustbox{valign=t}{%
...
\node[draw, thick, fill=gray!20, rounded corners, minimum width=2.6cm] (a) at (0,3) {1. Define Question};
\node[draw, rounded corners, minimum width=2.6cm] (b) at (0,2) {2. Check Data};
\node[draw, rounded corners, minimum width=2.6cm] (c) at (0,1) {3. Train Model};
\node[draw, rounded corners, minimum width=2.6cm] (d) at (0,0) {4. Act on Insights};
\draw[->] (a) -- (b);
\draw[->] (b) -- (c);
\draw[->] (c) -- (d);
\end{tikzpicture}
\end{center}
\tiny{The 4-step roadmap for this section: you are here.}
\end{minipage}%
}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{How Does Predictive Analytics Work?: Check Your Data}
Next,
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{How Does Predictive Analytics Work?: Train the Model}
Next,
\begin{itemize}
\item Train the system on your data so it can predict outcomes.
\item It should eventually identify patterns and trends about your customers and their behaviors.
\item Run one or more algorithms and pick the one that works best for your data.
\item Or pick an ensemble of these algorithms instead.
\end{itemize}

\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}\frametitle{How Does Predictive Analytics Work?: Act on the Insights}
Finally,
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.85\linewidth]{predanat21}
\end{center}
...
\item Clustering:
Finding natural groups or clusters in the data. K-means, Hierarchical, Spectral, Density-based (DBSCAN), EM/Gaussian Mixture etc
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Machine Learning Methods}
\begin{block}{Think About It}
A utility company wants to forecast next quarter's electricity prices using years of past
price data. Which of the four ML method categories (Regression, Classification, Time
Series Forecasting, Clustering) fits best, and why?
\end{block}
\end{frame}
...
\begin{frame}[fragile]\frametitle{Quick Check: Machine Learning Methods}
\begin{block}{Answer}
Time Series Forecasting: the task is specifically to predict a future value from an
ordered sequence of past values of the same variable, which is exactly what
AR/MA/ARIMA/Holt-Winters style methods are built for. Regression predicts an output from
other input variables (not from the variable's own history), Classification predicts a
category rather than a price, and Clustering groups existing data rather than predicting
the future.
\end{block}
\end{frame}
...
\begin{center}
\includegraphics[width=0.95\linewidth]{predanat6}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Moved to ml_production.tex, right after 'Building Blocks of a Cloud Deployment' where serverless is taught (Sep 2026 review).
