...
sub = arr[1:4]
      \end{lstlisting}
\begin{center}
\includegraphics[width=0.5\linewidth,keepaspectratio]{YHK_Color_OutOfTheBox}
\end{center}
    \end{column}
  \end{columns}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Graph Traversals - DFS \& BFS}
\begin{columns}
    \begin{column}[T]{0.5\linewidth}
      \begin{itemize}
...
# - Python documentation
      \end{lstlisting}
\begin{center}
\includegraphics[width=0.8\linewidth,keepaspectratio]{YHK_Color_OutOfTheBox}\\[0.3cm]
{\large Thank You! Happy Coding!}
\end{center}
    \end{column}
  \end{columns}
\end{frame}