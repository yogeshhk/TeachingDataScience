...
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio]{tree1.png}
\end{center}
...
\begin{frame}
	...
	\end{itemize}
			...
			\begin{itemize}
			\item \lstinputlisting{../Code/python/tree.py}
			\item 
			\item \lstinputlisting{../Code/python/treenode.py}
			\end{itemize}
\end{frame}
...
\begin{frame}
	\frametitle{Node Depth}
		...
		\lstinputlisting{../Code/python/nodedepth.py}
\end{frame}
...
\begin{frame}
	\frametitle{Tree Height}
		...
		\lstinputlisting{../Code/python/treeheight.py}
\end{frame}
...
How can we get all the leaves from a tree?
		...
		\lstinputlisting{../Code/python/treeleaves.py}
\end{frame}
...
By implementing it like this, we have no need for \texttt{TreeNode}s. All nodes are just \texttt{Tree}s!
		...
		\lstinputlisting{../Code/python/tree_alt.py}
\end{frame}
...
How do we determine the height in this set-up?
	...
	\lstinputlisting{../Code/python/tree_alt_height.py}
\end{frame}
...
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio]{avltree1.png}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio]{binarysearchtree1.png}
\end{center}
...
\begin{frame}
	\frametitle{Searching in a Binary SearchTree}
		...
		\lstinputlisting{../Code/python/search_btree.py}
...
Minmaxing like a real gamer:	So, how quickly can we find the minimum or maximum in a Binary Search Tree?
		...
		\lstinputlisting{../Code/python/minmax_btree.py}
...
\begin{frame}
	...
	\begin{columns}[T]
		\column{0.455\linewidth}
		\lstinputlisting{../Code/python/pq_array.py}
		\column{0.455\linewidth}
...
\begin{frame}
	...
	\begin{columns}[T]
		\column{0.455\linewidth}
		\lstinputlisting{../Code/python/pq_sortedarray.py}
		\column{0.455\linewidth}
