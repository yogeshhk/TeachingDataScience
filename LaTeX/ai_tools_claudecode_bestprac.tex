...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Plan Mode: Exploration, Ask Before Acting}
...
\textbf{Human in the Loop: Stay in Normal Mode}
  \begin{itemize}
    ...
    \item Only switch to auto-accept (\texttt{Shift+Tab} twice) for mechanical bulk edits already reviewed in plan mode.
  \end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{2. Repeated Workflows as Commands}
...
Why:
  \begin{itemize}
    ...
    \item Commit \texttt{.claude/commands/} to Git: the whole team benefits --- and commands improve alongside the codebase over time.
  \end{itemize}
...
\begin{frame}[fragile]\frametitle{4. Use docs/ for Progressive Disclosure}
  ...
  \begin{itemize}
    ...
    \item Keep architecture, ADRs (Architecture Decision Record), and runbooks in \texttt{docs/}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{8. Document Architecture Decisions}
  \begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{9. Structure $>$ Prompting Skill}
  \begin{itemize}
