...
\begin{frame}[fragile]\frametitle{The Alien's Next Token Prediction Problem}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.6\linewidth,keepaspectratio]{aiagent46}
...
\begin{frame}[fragile]\frametitle{Learning from Galileo: The Power of Models}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.6\linewidth,keepaspectratio]{aiagent45}
...
\begin{frame}[fragile]\frametitle{Introduction to Large Language Models}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.6\linewidth,keepaspectratio]{aiagent44}
...
\begin{frame}[fragile]\frametitle{What Makes Language Models "Large"?}
	  ...
	  \end{itemize}
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagent43}
...
\begin{frame}[fragile]\frametitle{Why Size Matters: Emergent Abilities}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagent41}
...
\begin{frame}[fragile]\frametitle{How Models Learn Language Through Next Token Prediction}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagent42}
...
\begin{columns}
    ...
    \begin{column}[T]{0.4\linewidth}
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents20}
...
\begin{columns}
    ...
    \begin{column}[T]{0.4\linewidth}
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents21}
...
\begin{frame}[fragile]\frametitle{Tools: The Agent's Arsenal of "Weapons"}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents37}
...
\begin{frame}[fragile]\frametitle{Chain-of-Thought: Foundation for Reasoning}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents36}
...
\begin{frame}[fragile]\frametitle{ReAct: Reasoning + Action Framework}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents39}
...
\begin{frame}[fragile]\frametitle{Memory: Essential for Agent Workflows}
	  ...
	  \end{itemize}
		...
		\begin{center}
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagent40}
