...
\begin{center}
\includegraphics[width=0.7\linewidth,keepaspectratio]{agents_levels}
\end{center}	  
...
\begin{frame}[fragile]\frametitle{Summary}
		\begin{center}
		\includegraphics[width=0.5\linewidth,keepaspectratio]{autoagent14}
		\end{center}
...
\begin{frame}[fragile]\frametitle{High-level flow of a coding agent}
	...
	\begin{center}
	\includegraphics[width=0.8\linewidth,keepaspectratio]{finetune16}
	\end{center}
