...
The domain is just "every input the function is allowed to eat without breaking." Dividing by zero has no answer, so $x=0$ is banned from $g$'s domain -- everything else is fair game.
\end{block}
\end{frame}
