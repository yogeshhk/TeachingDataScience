...
webinar available?
- Solution: Yes, webinars and recordings will be sent to you via email
‘within a few days.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{SQL Query Generation}

{\tiny (Ref: A Beginner's Guide to Prompt Engineering with ChatGPT - Datacamp)}


\begin{lstlisting}
Act as a data scientist. Here is a table {insert description of tables}.
Follow my instructions and follow them very carefully! Do not deviate
away from my instructions!

1. Can you write a SQL query on {query}?
2. Can you explain what the query does?
\end{lstlisting}		
