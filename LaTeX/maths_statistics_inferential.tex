...
A z-score just re-expresses "how far from average" in a universal unit: standard deviations. A z of 1.5 means the same thing whether you're talking GMAT scores, heights, or exam marks -- 1.5 standard deviations above average.
\end{block}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Inferential Statistics}
\begin{block}{Think About It}
Going from a 95\% confidence interval to a 99\% confidence interval for the same data -- does the interval get narrower or wider? Why?
\end{block}
\pause
\begin{block}{Answer}
Wider. To be more confident that the true population value is captured, you must cast a bigger net -- higher confidence always costs you precision (a wider range), for the same underlying data.
\end{block}
\end{frame}
