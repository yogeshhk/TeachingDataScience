...
# Note: LLMChain / RetrievalQA still ship inside 'langchain'
# They emit deprecation warnings. Migrate to LCEL chains instead.
# pip install langchain-classic  <-- does NOT exist on PyPI
