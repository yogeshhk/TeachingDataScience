...
Embed variables and expressions directly in strings by prefixing with \texttt{f}:
\begin{lstlisting}
name = "Alice"
age  = 30
...
\end{lstlisting}
f-strings are \textbf{faster}, \textbf{more readable}, and the \textbf{recommended} style for all new Python 3 code.
\end{frame}
