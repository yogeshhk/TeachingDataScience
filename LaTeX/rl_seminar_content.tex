...
\begin{frame}[fragile]\frametitle{Concepts}
\begin{center}
\includegraphics[width=0.6\linewidth,keepaspectratio]{rl33}
...
\includegraphics[width=0.5\linewidth,keepaspectratio]{rl15}
...
\begin{center}
\includegraphics[width=0.8\linewidth,keepaspectratio]{rl16}
\end{center}
...
\begin{center}
\includegraphics[width=0.8\linewidth,keepaspectratio]{rl28}
\end{center}
