% ============================================================
% DEPRECATED: graph_gdl_concepts.tex
% No longer \input{}'ed by seminar_graph_gdl_content.tex.
% Content reorganised into:
%   graph_gdl_manifolds.tex    -- Image Manifold + Manifold vs Graph
%   graph_gdl_5g.tex           -- GDL approaches + 5G Framework (lighter)
%   graph_gdl_advanced.tex     -- Lie Groups, heavy 5G, Challenges
%   graph_gdl_applications.tex -- Application lists
%   graph_gdl_start.tex        -- Libraries & Frameworks
% File kept as archive/reference only.
% ============================================================
...
\begin{column}{0.5\textwidth}
\begin{center}
\textit{[image: evolution of neural architectures — MLP, CNN, RNN, Transformer, GNN]}
\end{center}
\end{column}
\end{columns}
...
\begin{center}
\textit{[image: Felix Klein portrait / Erlangen Program diagram]}
...
\begin{center}
\textit{[image: 3D triangular mesh with shortest geodesic path highlighted]}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Gauge Networks: Applications}
...
\begin{column}{0.4\textwidth}
\begin{center}
\textit{[image: vector bundle with gauge connection over a manifold]}
