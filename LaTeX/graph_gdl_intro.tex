...
% MOVED TO HOOK: "Limitations of Current Models" and "Challenges in Generative Models"
% replaced by fresher-friendly "What Standard NNs Cannot Do" and "Real-World Wins" slides.
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Limitations of Current Models} ... \end{frame}
% \begin{frame}[fragile]\frametitle{Challenges in Generative Models} ... \end{frame}
...
% COMMENTED OUT (6 slides): too abstract as an opener for freshers; concepts covered later.
% Beyond Euclidean AI | Topology in Real-World Data | Geometry-Aware Neural Models
% Emerging Subfields  | Why Go Beyond Flat Space?   | From Euclidean to Topological AI
...
% COMMENTED OUT: "Symmetry and the Unification with Physics" — too formal for freshers at this stage.
% COMMENTED OUT: "Unifying Deep Learning with Geometry – The 5Gs" — covered in graph_gdl_5g.tex.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{}
\begin{center}
{\Large Data Has Shape}
\end{center}
\end{frame}
...
\begin{frame}[fragile]\frametitle{}
\begin{center}
{\Large Geometric Priors}
\end{center}
\end{frame}

% REMOVED: thin duplicate of "Geometric Priors" frame (kept the richer block-quote version above)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% REMOVED: thin duplicate — content covered fully in "Symmetry in machine learning" and "Back to symmetries"
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% REMOVED: thin duplicate — content covered fully in "Geometric Priors: Stability" (with image, below)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% COMMENTED OUT: "Example: Digit Classification" — same content covered in "Geometric Priors: Stability" below.
% \begin{frame}[fragile]\frametitle{Example: Digit Classification} ... \end{frame}

% REMOVED: thin duplicate — content covered fully in "Geometric Priors: Multi-scale" (with image, below)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% COMMENTED OUT: "Example: Multiscale Image Encoding" — same content covered in "Geometric Priors: Multi-scale" below.
% \begin{frame}[fragile]\frametitle{Example: Multiscale Image Encoding} ... \end{frame}
...
\item E.g. each image pixel is not independent but rather nearby pixels are often related and very similar. Like 'resolution' or zooming out and zooming in, scaling wise, preserves the structure, same as JPEG-2000 image compression, which compresses but preserves the image content.
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MOVED TO graph_gdl_gnn_primer.tex:
% Permutations | Neighborhood | Neighborhood Aggregation
% Building Blocks/Layers | Application | Example: CNN
...
% 
% \begin{itemize}
% \item Let’s define the set $N_i$ of the neighbors of node $i$ as $X_{N_i} = \{x_j : j \in N_i\}$ i.e. $x_1$ has neighbors called $X_{N_1}$
