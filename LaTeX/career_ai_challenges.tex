...
\item \textbf{Resume does not signal AI readiness:} A commerce or arts degree triggers an automatic filter in ATS systems
...
\item ``AI Trainer'' roles at RLHF companies (Scale AI, Outlier) pay well and require zero coding
\end{itemize}
    \end{column}
\end{columns}
