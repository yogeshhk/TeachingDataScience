...
\begin{center}
{\Large Background and Motivation}
\end{center}
\end{frame}
...
\hline
GPT-4 Turbo & Unknown & 128K & Yes & No \\
Claude 3.5 & Unknown & 200K & Yes & No \\
Gemini 1.5 Pro & Unknown & 2M & Yes & No \\
Llama 3.1 405B & 405B & 128K & No & Yes \\
Mixtral 8x22B & 141B & 64K & No & Yes \\
\hline
\end{tabular}
\end{table}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{State of LLMs in 2024-2026}
\begin{itemize}
    \item GPT-4o, GPT-4 Turbo (Multimodal capabilities)
    \item Claude 3.5 Sonnet, Opus (Extended context windows)
    \item Gemini 1.5 Pro, Ultra (2M token context)
    \item Llama 3, 3.1, 3.2 (Open-source advancement)
    \item Mixtral 8x22B (Mixture of Experts)
    \item Command R+, Phi-3 (Efficiency focus)
\end{itemize}
{\tiny (Ref: Model releases 2024-2026)}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Beyond Standard Transformers}
\begin{itemize}
    \item Mixture of Experts (MoE): Mixtral, GPT-4 architecture
    \item Long Context Models: Techniques for 100K+ token windows
    \item Sparse Attention Mechanisms: FlashAttention, Linear Attention
    \item State Space Models: Mamba, alternatives to attention
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Advanced Fine-tuning Methods}
\begin{columns}
    \begin{column}[T]{0.5\linewidth}
    ...
    \begin{column}[T]{0.5\linewidth}
        ...
        \begin{itemize}
            ...
            \item Multiple task-specific models
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{LLM Safety Challenges}
\begin{itemize}
    \item Jailbreaking \& Prompt Injection
    \item Data Poisoning Attacks
    \item Model Extraction
    \item Misinformation Generation
    \item Bias Amplification
    \item Privacy Concerns (memorization)
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Emerging Trends}
\begin{itemize}
    \item Small Language Models (SLMs): Phi, Gemma
    \item On-device LLMs: Mobile deployment
    \item Continual Learning: Models that update knowledge
    \item Reasoning Models: Chain-of-thought, o1-preview
    \item Agentic AI: Autonomous task completion
    \item Personalization: User-specific fine-tuning
\end{itemize}
\end{frame}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        ...
        \begin{itemize}
            ...
            \item Communities to join
        \end{itemize}
        
        Practice Projects:
        \begin{itemize}
            \item Build a chatbot
            \item Create RAG system
            \item Fine-tune a model
            \item Deploy an API
        \end{itemize}
    \end{column}
\end{columns}
