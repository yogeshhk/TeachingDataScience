...
# Import PPO trainer from RLlib (ray.rllib.agents.ppo in Ray < 2.0)
from ray.rllib.agents.ppo.ppo import PPOTrainer

# Re-create an empty agent with the same config used during training
agent = PPOTrainer(config={"env": "CartPole-v1",
                           "evaluation_interval": 2,   # evaluate every 2 training iters
                           "evaluation_num_episodes": 20  # episodes per evaluation
                           }
                   )
# Restore weights and state from a saved checkpoint directory
