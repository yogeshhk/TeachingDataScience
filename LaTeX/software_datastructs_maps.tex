...
\begin{frame}
	...
	Which is better?	
		...
		% \end{itemize}
			...
			\begin{itemize}
			\item \lstinputlisting[ basicstyle=\tiny]{../Code/python/point.py}
			\item 
			\item \lstinputlisting[firstline=4, lastline=15,  basicstyle=\tiny]{../Code/python/point2.py}
	\end{itemize}
...
\begin{frame}
	...
	\begin{columns}[T]
		...
		\lstinputlisting[basicstyle=\tiny\ttfamily]{../Code/python/hashmap.py}
	\end{columns}
\end{frame}
