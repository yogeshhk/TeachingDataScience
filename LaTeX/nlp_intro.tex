...
\item NLP is considered one of the hardest open problems in AI
\item Cracking language is essentially equivalent to cracking general AI itself
\end{itemize}
\end{frame}
...
\begin{itemize}
\item \textbf{AI-Complete}: as hard as the hardest problems in AI — solving NLP fully would require solving all of AI
