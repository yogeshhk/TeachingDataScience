...
python -m venv rag-demo
source rag-demo/bin/activate   # Linux/Mac
# rag-demo\Scripts\activate   # Windows
...
# DocstringLoader reads the file and
# preserves paragraph structure.
# Each paragraph -> one Document object.
loader = TextLoader(
    file_path="faq.txt",
    encoding="utf-8"
)
