...
\item The neo4j package exports a GraphDatabase object. This object provides a driver() function for creating a new driver instance.
\end{itemize}
...
driver = GraphDatabase.driver("neo4j://localhost:7687",
    auth=("neo4j", "neo4j"))  # use actual password
...
from_timestamp = neo4j.time.DateTime.from_timestamp(1609459200)  # 2021-01-01
