...
% Duplicate "Cool-down: Summary" removed here (Aug 2026 /upgrade-deck pass) -- an
% identical frame already closes the deck; keeping only one avoids two verbatim
% copies of the same check-in question mid-deck and at the end.
...
\begin{frame}[fragile]\frametitle{}
\begin{center}
{\Large Why Machine Learning Matters?}
\end{center}
\end{frame}
...
\item Mathematical entities added to input data, are Parameters.. $c$, $\beta_0$ and $\beta_1$ are parameters
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Hardware Revolution}
\begin{itemize}
\item GPUs (NVIDIA H100, AMD MI300)
\item TPUs (Tensor Processing Units)
\item Edge AI chips (Apple Neural Engine, Google Tensor)
\item Quantum computing for ML (early stages)
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{The ML Renaissance (2023-2025)}
\begin{itemize}
\item Large Language Models (ChatGPT, GPT-4, Claude)
\item Generative AI explosion
\item Multi-modal models (text, image, video, audio)
\item AI democratization through APIs
\item MLOps maturity
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Open Source ML Ecosystem 2025}
\begin{columns}
\column{0.5\textwidth}
Frameworks:
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Why ML Matters}
\begin{block}{Think About It}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Big Data Context}
\begin{block}{Think About It}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: A Puzzle}
\begin{block}{Think About It}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Three kinds of learning}
\begin{itemize}
\item \textbf{Supervised}: learn from labeled examples (input-output pairs)
\item \textbf{Unsupervised}: find hidden structure in unlabeled data
\item \textbf{Reinforcement}: learn by trial-and-error to maximize cumulative reward (e.g., AlphaGo, robotics)
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Machine Learning Algorithms}
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{ML Algorithms: Five Key Questions}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Classification: Overview}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Clustering: Overview}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Dimensional Reduction}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Ranking: Overview}
\begin{itemize}
\item \textbf{Description:} Ordering a set of items by relevance or preference, not just labeling or measuring them individually.
\item \textbf{How it differs:} Classification asks ``what is this?'' for one item at a time; Ranking asks ``which of these should come first?'' for a whole set at once.
\item \textbf{Applications:} Search engine results, Recommender systems, Leaderboards
\item \textbf{Algorithms:} Learning-to-Rank methods (e.g., RankNet, LambdaMART), often built on Gradient Boosting
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Choosing which algorithm, or family of algorithms, fits the problem -- before any parameter gets fit.
\item Driven by the problem type (Classification/Regression/Clustering/Ranking), data size, interpretability needs, and training-time budget.
\item Rule of thumb: start simple (Linear/Logistic Regression) as a baseline, move to more flexible models (Trees, SVM, Ensembles) only if the baseline underfits.
\item Not a one-time choice: gets revisited once evaluation metrics come in, and again once feature selection changes what the model has to work with.
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Decision Tree: Feature Selection}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Decision Tree Population}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Classification: University Admission Example}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Classification: Decision Boundary}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Classification: Spam Detection Example}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Clustering: Pizza Shop Example}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Clustering: K-Means Convergence}
...
% \begin{frame}[fragile]\frametitle{}
% \begin{center}
% {\Large Modern ML Paradigms}
% \end{center}
% \end{frame}


% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Beyond Traditional ML: Modern Paradigms}
% \begin{itemize}
% \item Transfer Learning
% \item Few-Shot \& Zero-Shot Learning
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{AutoML - Automated Machine Learning}
% Automates:
% \begin{itemize}
...
% # One line to train multiple models
% predictor = TabularPredictor(label='target').fit(train_data)

% # AutoGluon tries: XGBoost, Random Forest, Neural Networks
% # and creates ensemble automatically
% predictions = predictor.predict(test_data)
% \end{lstlisting}
% \end{frame}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Explainable AI (XAI)}
% Why Model Explainability Matters:
% \begin{itemize}
% \item Healthcare decisions
% \item Financial lending
% \item Legal compliance
% \item  Trust and adoption
% \end{itemize}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Federated Learning - Privacy-Preserving ML}
% Use Cases:
% \begin{itemize}
% \item Medical data across hospitals
% \item Mobile keyboard predictions
% \item Financial fraud detection
% \end{itemize}

% Key Benefit: Data never leaves local device/institution
% \end{frame}


% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Reinforcement Learning in Practice}
% Success Stories:
% \begin{itemize}
% \item AlphaGo (2016) → AlphaZero (2017)
% \item OpenAI Five (Dota 2, 2018)
% \item  DeepMind's protein folding (AlphaFold, 2020)
% \item ChatGPT with RLHF (2022-2025)
% \end{itemize}
...
% for episode in range(1000):
    ...
    % while not done:
        % action = policy(observation)  # Agent decides
        % observation, reward, done, truncated, info = env.step(action)
        % update_policy(reward)  # Learn from reward
% \end{lstlisting}
% \end{frame}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Edge AI \& TinyML}
% ML on Devices:
% \begin{itemize}
% \item Smartphones (Apple Neural Engine, Qualcomm AI Engine)
% \item IoT sensors
% \item Wearables
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{ML Model Deployment Pipeline (MLOps)}
% Modern Stack:
% \begin{itemize}
% \item Docker/Kubernetes for containerization
% \item  FastAPI/Flask for serving
% \item Prometheus/Grafana for monitoring
% \item Airflow/Prefect for orchestration
% \end{itemize}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Model Performance Beyond Accuracy}
% Comprehensive Evaluation:
% \begin{itemize}
% \item Precision, Recall, F1-Score
% \item ROC-AUC, PR-AUC
% \item  Confusion Matrix
% \item  Bias and Fairness metrics
% \end{itemize}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{ML System Design Patterns}
% Common Patterns:
% \begin{itemize}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{frame}[fragile]\frametitle{Ethical Considerations in ML}
% Key Challenges:
% \begin{itemize}
% \item Bias in training data
% \item Model fairness across demographics
% \item Privacy concerns (GDPR, data rights)
% \item  Transparency and explainability
% \item Environmental impact (carbon footprint)
% \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Types of Machine Learning}
\begin{block}{Think About It}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Future Trends \& Challenges}
Emerging Areas:
\begin{itemize}
\item AGI (Artificial General Intelligence) research
\item Quantum Machine Learning
\item Neuromorphic computing
\item  AI-human collaboration tools
\end{itemize}

Challenges Ahead:
\begin{itemize}
\item Data scarcity for specialized domains
\item Model interpretability at scale
\item Energy-efficient AI
\item Regulation and governance
\item AI safety and alignment
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Applications \& Future}
\begin{block}{Think About It}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{What We Covered}
\begin{itemize}
\item \textbf{What is ML?}: Learning patterns from data, not explicit rules
\item \textbf{Types}: Supervised (labeled data), Unsupervised (hidden structure), Reinforcement (reward signals)
\item \textbf{Math framework}: $Y = f(X) + \epsilon$; minimize loss to approximate $f$
\item \textbf{Evaluation}: Cross-validation, confusion matrix, precision, recall, F1, bias-variance tradeoff
\item \textbf{Toolkit}: scikit-learn's Estimator API (fit / predict / score)
\end{itemize}
\textbf{Next}: Data preparation and hands-on pipelines
\end{frame}
