...
\begin{lstlisting}
# Install PyG (handles most dependencies automatically for PyTorch >= 1.12)
pip install torch-geometric

# If optional sparse/scatter extensions are needed (replace TORCH and CUDA):
...
\begin{lstlisting}
from torch_geometric.datasets import TUDataset
from torch_geometric.loader import DataLoader  # moved from torch_geometric.data in PyG 2.0
