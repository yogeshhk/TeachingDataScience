...
\item Also, $X^TX$ cannot be inverted if any two columns (features) are identical, or one is a combination of others.
...
\item There are no slope formulas for these $\beta$s. So, we will solve the machine learning way.
\end{itemize}
