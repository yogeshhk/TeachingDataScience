...
\begin{frame}[fragile]\frametitle{QA Subagent}
  ...
  \begin{itemize}
	...
	\item Use the qa subagent to write tests/conftest.py with fixtures: \lstinline|valid_box_mesh, non_watertight_mesh, degenerate_face_mesh|. Then write \lstinline|tests/test_core.py| covering all three cases against \lstinline|core.inspect_mesh()|.
  \end{itemize}
...
## Usage:
Use the qa subagent to write tests/conftest.py with
fixtures: valid_box_mesh, non_watertight_mesh,
degenerate_face_mesh. Then write tests/test_core.py
covering all three cases against core.inspect_mesh().
\end{lstlisting}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Wire Up Hooks in .claude/settings.local.json}
  \begin{itemize}
