...
np.linalg.matrix_rank(F)  # np.rank() removed in NumPy 1.25
...
\begin{equation}
3 \times A = 3 \times \begin{bmatrix} a_{11} & a_{12} \\ a_{21} & a_{22}
\end{bmatrix}
=
\begin{bmatrix}
  3a_{11} & 3a_{12} \\
...
SVD says any transformation, however complex, can be broken into three simple steps: rotate, stretch along axes, rotate again. It's the linear-algebra version of "any messy motion is just a rotate-stretch-rotate in disguise."
\end{block}
