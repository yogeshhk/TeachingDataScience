...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{MCP in LLM Agents}

        \begin{center}
		
        \includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents117}

		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents118}
		
		\includegraphics[width=0.8\linewidth,keepaspectratio]{aiagents119}
