...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Quick Check: Gaussian Elimination}
\begin{block}{Think About It}
You row-reduce a $3\times3$ coefficient matrix $A$ and find that one column has no pivot. What does that tell you about whether the columns of $A$ are linearly independent?
\end{block}
\pause
\begin{block}{Answer}
