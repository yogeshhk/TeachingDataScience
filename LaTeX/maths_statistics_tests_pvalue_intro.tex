...
A small p-value doesn't mean "the effect is real and important" -- it means "this data would be surprising if there were truly no effect." It's a measure of surprise under the null hypothesis, not a measure of how big or meaningful the effect actually is.
\end{block}
\end{frame}
