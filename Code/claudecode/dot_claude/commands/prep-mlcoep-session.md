...
the rest, clean up dashes, compile, upgrade, recompile, rename, then restore.
...
If a quote-attribution dash reads awkwardly as a colon or comma, use a plain hyphen (`-`) instead
