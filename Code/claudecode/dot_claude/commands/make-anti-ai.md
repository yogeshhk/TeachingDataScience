...
For every issue found, report it in this exact order — no prose, no preamble:

**Fix:** [violation type, e.g. Rule 3F, Dead vocab, Typo]
**Location:** [page and paragraph, e.g. p.1, para 3]
**Correction:** "[original text]" → "[revised text]"

One block per issue. Nothing else between them.
