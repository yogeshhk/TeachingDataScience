class Node:
    ...
    def __init__(self, value: str):
        self.value = value
        self.next_node = None
        # This variable points towards the previous node
        # It is not used for a SLL, but will be useful in your DLL
        self.prev_node = None
...
class LL:
    ...
    def __init__(self):
        self.head = None
        self.size = 0
        # This variable points towards to the tail of the linked list
        # It is not used for a SLL, but will be useful in your DLL
        self.tail = None
