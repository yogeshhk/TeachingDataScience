...
Everything here — slides, code, notes — has been built by learning from, and citing, the best public material available, and is given back under an open license so anyone can teach, learn, or build on it.
