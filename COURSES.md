...
All-in-one driver: [`Main_Course_MLCoEP_Presentation.tex`](LaTeX/Main_Course_MLCoEP_Presentation.tex)

A bespoke 20-session course built for College of Engineering Pune (CoEP), pairing Python/ML
fundamentals with mechanical-engineering-flavored applications and project ideas. Unlike the
5 courses above, it has no separate workshop layer; all 20 sessions are chained directly into
the single all-in-one course driver above: AI Overview, Python Overview, EDA & Data Preparation,
Pandas, Introduction to ML, Core ML Concepts, ML Workflow & Model Evaluation, Feature Selection,
Linear Regression, Logistic Regression, Decision Trees, Ensemble Methods & Random Forest, SVM,
Naive Bayes, KNN, K-Means, PCA, Titanic Capstone, MLOps & Deployment, and AI/ML Applications &
Project Ideas for ME.
...
| Reinforcement Learning | [`Main_Workshop_ML_ReinforcementLearning_Presentation.tex`](LaTeX/Main_Workshop_ML_ReinforcementLearning_Presentation.tex): [Intro](LaTeX/Main_Seminar_ML_ReinforcementLearning_Intro_Presentation.tex), [Concepts](LaTeX/Main_Seminar_ML_ReinforcementLearning_Concepts_Presentation.tex), [MDP](LaTeX/Main_Seminar_ML_ReinforcementLearning_MDP_Presentation.tex), [Q-Learning](LaTeX/Main_Seminar_ML_ReinforcementLearning_QLearning_Presentation.tex), [Deep Q-Learning & Modern RL](LaTeX/Main_Seminar_ML_ReinforcementLearning_DeepQLearning_Presentation.tex), [Tools & Frameworks](LaTeX/Main_Seminar_ML_ReinforcementLearning_Tools_Presentation.tex), [Applications](LaTeX/Main_Seminar_ML_ReinforcementLearning_Applications_Presentation.tex) | MDPs, Q-learning, deep Q-learning, RLlib, OpenAI Gym, tic-tac-toe implementation |
...
- **AI for different audiences** (each now includes ChatGPT coverage folded in, at a depth matched to its audience): [All Tech](LaTeX/Main_Seminar_AI_For_All_Tech_Presentation.tex), [All Non-Tech](LaTeX/Main_Seminar_AI_For_All_NonTech_Presentation.tex), [Educators](LaTeX/Main_Seminar_AI_For_Educators_Presentation.tex), [Kids](LaTeX/Main_Seminar_AI_For_Kids_Presentation.tex), [Biz Leaders](LaTeX/Main_Seminar_AI_For_BizLeaders_Presentation.tex), [Tech Leaders](LaTeX/Main_Seminar_AI_For_TechLeaders_Presentation.tex), [Project Managers](LaTeX/Main_Seminar_AI_For_ProjectManagers_Presentation.tex), [With ML](LaTeX/Main_Seminar_AI_For_WithML_Presentation.tex)
...
- **Deep Learning platforms**: [TensorFlow](LaTeX/Main_Seminar_DL_Tensorflow_Presentation.tex), [PyTorch](LaTeX/Main_Seminar_DL_Pytorch_Presentation.tex), [Data + TensorFlow](LaTeX/Main_Seminar_DL_Data_TensorFlow_Presentation.tex), [Satellite Imagery](LaTeX/Main_Seminar_DL_SatelliteImagery_Presentation.tex)
- **Graph topics**: [Neo4j](LaTeX/Main_Seminar_Graph_Neo4j_Presentation.tex), [Graph Data Science](LaTeX/Main_Seminar_Graph_DataScience_Presentation.tex), [Graph + NLP](LaTeX/Main_Seminar_Graph_NLP_Presentation.tex), [Graph RAG](LaTeX/Main_Seminar_Graph_RAG_Presentation.tex) (Knowledge Graphs: see the Knowledge Graphs workshop above)
...
- **Multi-agent frameworks**: [Multi-Agent Decision Systems (MADS)](LaTeX/Main_Seminar_LLM_MADS_Presentation.tex): a configuration-driven multi-agent orchestration framework (Oracle/Specialist/Synthesizer architecture, Game Theory, Mental Models, TRIZ domains)
